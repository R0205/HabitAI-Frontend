    ...
    >
      ...
      <div className="relative z-10 text-center text-white px-6 py-16 md:px-12 md:py-24">
        <div className="max-w-2xl mx-auto mt-10">
          ...
          <a
            href="/signup"
            className="bg-blue-600 px-9 py-5 text-2xl rounded-full text-white hover:bg-blue-800 transition-all duration-300 ease-in-out transform hover:scale-105 shadow-lg hover:shadow-2xl"
          >
            Get Started
          </a>
        </div>
